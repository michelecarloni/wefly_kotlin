...
class DettagliViaggiPassatiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getData = intent.getParcelableExtra<ModelElencoViaggi>("passati")!!
        if (getData != null) {
            ...
            Glide.with(this) // Use the context from the holder's itemView
                ...
                .into(detailImageIdPassati)

            // setta detailTipoViaggio
            detailTipoViaggioPassati.text = calcolaTipoViaggio()

            //setta detailAffinita
            detailAffinitaPassati.text = calcolaAffinita()
